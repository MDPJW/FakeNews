...
|EMERGENT|article : fact_tag(Label), Emerget_url, title, gategory, claim, claim_descript, publish_date, body<br/><br/> original : origin_url, text, title, date, author|TRUE/FALSE[2가지]|
...
|snope |article : fact_tag(Label), Snope_url, title, category, claim, claim_descript, date<br/><br/> original : origin_url, index_paragraph, text, title, date, author|TRUE/Mostly True/Mixture/Mostly False/False/Unproven/Outdated/Miscaptioned/Correct Attribution/Misattributed/Scam/Legend/Labeled Satire/Lost Legend(14가지)|
